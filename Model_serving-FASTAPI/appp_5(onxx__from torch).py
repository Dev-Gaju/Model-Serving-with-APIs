...
"""
__author__ = "Adnan Taufique"
__email__ = "adnan.polyfins@gmail.com"
...
async def predict(image: UploadFile = File(...), top_n: str = '5'):
    ...
    print("probability prediction",pred_proba)
    pred_class = decode_predictions(preds, top=top_n)  # ImageNet Decode
    print("proba class",pred_class)
...
if __name__ == "__main__":
    ...
    uvicorn.run("appp_5:app", host="127.0.0.1", port=5002)